...
const calcSize = (width: number) => {
  const smWidth = Number.parseFloat(getCssVarsValue('--td-screen-sm')) || 768;
  const mdWidth = Number.parseFloat(getCssVarsValue('--td-screen-md')) || 992;
  const lgWidth = Number.parseFloat(getCssVarsValue('--td-screen-lg')) || 1200;
  const xlWidth = Number.parseFloat(getCssVarsValue('--td-screen-xl')) || 1400;
  const xxlWidth = Number.parseFloat(getCssVarsValue('--td-screen-xxl')) || 1880;
