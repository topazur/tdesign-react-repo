...
collapsedItems | TElement | - | Typescript：`TNode<{ value: DataOption[]; onClose: (p: { e?: MouseEvent<SVGSVGElement>; index: number }) => void; }>`。[see more ts definition](https://github.com/Tencent/tdesign-react/blob/develop/src/common.ts) | N
